...
#d <- dist(carros[, 2:29], method="euclidean")

# ----------------------------------
# DUVIDA: quais valores devo usar, acima?
# ----------------------------------
...
#clusters_cut <- cutree(clusters, k=30)

# Mostra os resultados
#table(clusters_cut, carros$V1)

# Visualiza os agrupamentos
#ggplot(carros, aes(V1,  V3, V19, V21, V23, V5_turbo, V7_convertible, V7_sedan, #V7_wagon, V7_hardtop, V8_4wd, V9_rear, V15_dohc, V15_ohcv, V15_ohc, V15_l, V15_ohcf, #V15_dohcv, V16_six, V16_five, V16_three, V16_twelve, V16_two, V16_eight, V18_2bbl, #V18_mfi, V18_1bbl, V18_spfi, V18_spdi, color=V1)) + 
#  geom_point(alpha=0.4, size=3.5) + 
#  geom_point(col=clusters_cut) + 
#  scale_color_manual(values=c('black', 'red', 'green'))

# ----------------------------------
# DUVIDA: como visualizar os agrupamentos? 
# ----------------------------------
...
#TODO: não encontrado parametro para mínimo=2
...
# TODO: erro ao utilizar NbClust
#nb <- NbClust(carros_scaled, distance="euclidean", 
#              min.nc=2, max.nc=10, method="complete", 
#              index="all")

# utilizacao de eclust que, internamente, utiliza NbClust
library(factoextra)
