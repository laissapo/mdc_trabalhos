...
Com densidade igual em 2.5, engloba todos os exemplos e tem k=2 para qualquer minPts.

Após a experimentação, principalmente para o eps=2.0, minPts com 3 e 5 parecem bons. Então, decidimos por minPts=5.

Após decidirmos pelo minPts=5, executamos o kNNdistplot para escolher o melhor eps. Analisando o gráfico pelo "cotovelo", concluímos que em eps=1.9 o gráfico dá um salto maior.

Após decidirmos por minPts=5 e "calcularmos" eps=1.9, geramos um gráfico de dispersão, onde os 2 cluster foram mostrados. Pelo gráfico, os cluster estão bem separados. Na imagem 2D, nenhum ponto de um cluster ficou dentro de outro, ou seja, os 2 clusters estão bem definidos. O resultado ainda apresentou alguns outliers, em preto.
...
a) Ambos os métodos retornaram k=2. Entre os dois gráficos gerados, ainda que analisando em 2D, o DBScan parece ter agrupado melhor os exemplos.

b) Ambos os métodos retornaram 2 agrupamentos.
